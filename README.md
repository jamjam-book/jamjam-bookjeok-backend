...
<details>
  ...
  <details>
    ...
    <details>
      ...
      <img src="assets/test/구매/06_장바구니 목록 조회.png" alt="장바구니 목록 조회" />
    </details>
    <details>
      <summary>장바구니 등록</summary>
      <img src="assets/test/구매/05_장바구니 도서 등록.png" alt="장바구니 등록" />
    </details>
    <details>
      <summary>장바구니 도서 수량 변경</summary>
      <img src="assets/test/구매/04_장바구니 도서 수량 변경.png" alt="장바구니 도서 수량 변경" />
    </details>
    <details>
      <summary>장바구니 도서 삭제</summary>
      <img src="assets/test/구매/03_장바구니 도서 삭제.png" alt="장바구니 도서 삭제" />
    </details>
  </details>  
  <details>
    <summary>임시 주문 정보</summary>
    <details>
      <summary>임시 주문 정보 생성</summary>
      <img src="assets/test/구매/02_임시 주문 정보 생성.png" alt="임시 주문 정보 생성 주문" />
    </details>
    <details>
      <summary>임시 주문 정보 삭제</summary>
      <img src="assets/test/구매/07_임시 주문 정보 삭제.png" alt="임시 주문 정보 생성 주문" />
    </details>
  </details>
  <details>
