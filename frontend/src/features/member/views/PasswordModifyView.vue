    ...
    <div class="auth-container">
        <div class="input-box">
            <div class="password-reset-group">
                <label for="nowPassword" class="label">현재 비밀번호</label>
                <input
                        id="nowPassword"
                        type="password"
                        placeholder="현재 비밀번호를 입력해주세요."
                        class="input"
                        v-model="formData.nowPassword"
                        @input="validateField('nowPassword')"
                        @click="validateField('nowPassword')"
                />
                <span v-if="errors.nowPassword" class="error">{{ errors.nowPassword }}</span>
